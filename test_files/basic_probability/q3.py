q3 = {
    ...
    "question": "Ashley and Manuel are about to play a tennis match. The probability of Ashley winning the match is 0.62. What is the probability that Manuel will win the match?",
    "userPrompts": [
        # {
        #     "prompt": "asdfasdfadsf",
